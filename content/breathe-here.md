...
*After three years of silence, she finally wrote.*
*Honestly, I had no idea.*
*When the fog lifted, the harbour appeared.*
...
*She needed: time, silence, and a better question.* ✗ — the clause before the colon is not complete.
*The colours are: red, blue, and green.* ✗ — same problem.
...
*She had planned everything perfectly — or so she believed.*
...
*2019–2026* &emsp; *pages 14–22* &emsp; *Monday–Friday* &emsp; *9:00–17:00*
...
*post–World War II architecture* &emsp; *Nobel Prize–winning research* &emsp; *New York–based company*

**Versus and connection.** The en dash can indicate a connection or contrast between two things of equal weight.

*the London–Edinburgh train* &emsp; *the conservative–liberal coalition*
...
*a well-known writer* &emsp; *a first-rate solution* &emsp; *a fast-moving story*
...
*The writer is well known.* &emsp; *The solution was first rate.* &emsp; *The story was fast moving.*
...
*first- and second-year students* &emsp; *three- to five-bedroom houses*
...
*The treaty was signed in 1648 (though ratified only the following spring) and remained in force for a century.*
*The document used ISO 8601 (the international date format standard) throughout.*
...
*She was exhausted. (She had not slept in two days.)* — complete sentence: full stop inside.
*She was exhausted (she had not slept in two days), but she kept going.* — embedded: comma outside, no mark inside.
...
*Running through the rain.* — no subject, no main verb.
*Which she had known all along.* — a subordinate clause, not a sentence.
...
*Where did she go?* — direct question: question mark.
*He asked where she had gone.* — indirect question: full stop. The asking is reported; no question is posed to the reader.
*I wonder whether she'll come.* — indirect: full stop.
*Will she come? I wonder.* — direct: question mark after the direct question, full stop after the statement.
...
*American:* "She said, 'Don't wait for me,' and was gone."
*British:* 'She said, "Don't wait for me," and was gone.'
...
*She called it "a disaster," and moved on.*
*The note read "do not disturb."*
...
*She called it 'a disaster', and moved on.*
*The note read 'do not disturb'.*
*Did she say 'don't wait'?* — the question mark belongs to the surrounding sentence, so it goes outside.
...
- Singular noun: add *'s* → *the cat's bowl*, *the city's streets*, *James's coat*
- Plural noun ending in S: add only the apostrophe → *the cats' bowls*, *the cities' streets*
- Plural noun not ending in S: add *'s* → *the children's shoes*, *the women's vote*
- *Its* as a possessive: **no apostrophe** → *the cat licked its paw*
...
*it is → it's* &emsp; *you are → you're* &emsp; *they are → they're* &emsp; *do not → don't* &emsp; *cannot → can't* &emsp; *of the clock → o'clock*
...
*the 1990s* (not *the 1990's*) &emsp; *CDs* (not *CD's*) &emsp; *three coffees* (not *three coffee's*)
...
*"She [the director] was adamant that the project would be completed on time."*
*"The council voted in favour [of the proposal] by a narrow margin."*
...
&emsp; Parentheses (whisper) → Commas (quiet fold) → Em dashes (full voice)

**For pauses within a sentence, from lightest to heaviest:**

&emsp; Comma (breath) → Semicolon (lean) → Colon (announce)

**For endings, from flattest to most emphatic:**

&emsp; Full stop (complete) → Question mark (open) → Exclamation mark (rare peak)

**For joining compound elements, from narrowest to widest span:**

&emsp; Hyphen (single compound) → En dash (range or multi-word compound) → Em dash (interruption)
...
*This post is a companion to [A Key for Every Lock: English Confusions Cleared Once and For All](@/a-key-for-every-lock.md), where the same treatment is given to commonly confused words and phrases. The two articles together form a complete guide to the confusions that trouble careful writers most.*
...
<p>
{{ image(src="/breath_here.jpg", alt="A 19th-century wood engraving by J. W. Orr showing a teacher using a pointer to indicate punctuation marks on a blackboard — comma, semicolon, colon, full stop, question mark, and exclamation mark — while six children stand with their backs to the viewer, looking on", title="Courtesy of John William Orr — Public Domain", style="border-radius: 8px;") }}
</p>
