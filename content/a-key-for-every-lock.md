...
> **Wrist tattoo:** *Occasionally* → *sometimes*. *A period* → *some time*. *At some vague future moment* → *sometime*.
...
> **Wrist tattoo:** Replace with *by now* or *previously* — if it holds → *already*. If you mean *fully prepared* → *all ready*.
...
> **Wrist tattoo:** Try substituting *on top of*. *Jumped onto the stage* → *jumped on top of the stage* ✓ → one word. *Moved on to the next chapter* → *moved on top of the next chapter* ✗ → two words.
...
> **Wrist tattoo:** Can you replace *in to* with *in order to*? *Came in to help* = *came in order to help* ✓ → two words. *Walked into the room* → *walked in order to the room* ✗ → one word.
...
> **Wrist tattoo:** *They are* → *they're*. That place (does it contain *here*? — *t-here*) → *there*. Belonging to them → *their*.
...
> **Wrist tattoo:** Expand it. *You are welcome* → *you're welcome* ✓. *You are dog* → nonsense → *your dog*.
...
> **Wrist tattoo:** Expand it. *It is raining* → *it's raining* ✓. *The cat licked it is paw* → nonsense → *its paw*.
...
> **Wrist tattoo:** The number → *two*. *Also* or *excessively* → *too* (it has too many O's — there's your sign). Direction or infinitive → *to*.
...
> **Wrist tattoo:** RAVEN — **R**emember **A**ffect **V**erb **E**ffect **N**oun.
...
> **Wrist tattoo:** NAVAL = NAVY (NAV is in both). NAVEL = belly button (it is in the middle of the body, and the E sits in the middle of nav*E*l).
...
*"She sought advice before she felt qualified to advise others."*
*"He needed a licence to practise medicine, so he returned to his practice for the paperwork." (British)*
...
> **Wrist tattoo:** Substitute *he* or *him*. *He called* (not *him called*) → *who*. *Write to him* → *whom*. HE → WHO. HIM → WHOM (both end in M — a tidy coincidence, and a permanent one).
...
|---|---|---|---|
| **lay** (to place) | I lay the book down | I laid the book down | I have laid the book down |
| **lie** (to recline) | I lie down | I lay down | I have lain down |
...
<p>
{{ image(src="/every_lock.jpg", alt="A brass skeleton key resting before a stack of aged books with gilded edges, two small forget-me-not flowers tucked against the spine", title="Courtesy of hehaden — CC BY-NC 2.0", style="border-radius: 8px;") }}
</p>
